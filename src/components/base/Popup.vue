    ...
    <div class="popup-content">
      <div class="popup-body">
        <div
          ...
          class="popup-icon background-icon position-icon-warning"
        ></div>
        <div
          v-if="popupType == 'question'"
          class="popup-icon background-icon position-icon-question"
        ></div>
        <div
          v-if="popupType == 'danger'"
          class="popup-icon background-icon position-icon-danger"
        ></div>
